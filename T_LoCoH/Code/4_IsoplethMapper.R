#B. Raynor
#Plots GPS points, isopleths sorted by density on open street map
...
for(i in 1:IDLength) {
  ...
  setwd(path)
  sh.name <- paste(dogname, ".iso.srt-nep.iso-q.h", n1, ".i5.00.iso.shp", sep="" )
  ...
  #savemap
  setwd("~/2019_DogMovementCode/T_LoCoH/Output/IsoMaps")
  png(paste(dogname, "Iso.png", sep=""), width=8, height=4, units="in", res=300) 
  print(p0)
  dev.off()
}
